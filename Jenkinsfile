pipeline {
    ...
    environment {
        ...
        // Sesuaikan dengan metadata.name di kubernetes/deployment.yaml Anda
        APP_DEPLOYMENT_NAME      = 'carvilla-web' // DISESUAIKAN berdasarkan file Anda sebelumnya
        
        // Sesuaikan namespace jika aplikasi Anda di-deploy ke namespace selain 'default'
        // File YAML aplikasi Anda menggunakan 'default', jadi ini sudah benar.
    ...
    stages {
        ...
        stage('Run Tests (Placeholder)') {
            ...
            steps {
                container('jnlp') { // Container utama agent
        ...
        stage('Build and Push Docker Image') {
            ...
            steps {
                container('docker') { // Menjalankan perintah Docker di container 'docker'
                    script {
        ...
        stage('Deploy to Kubernetes') {
            ...
            steps {
                container('kubectl') { // Menjalankan perintah kubectl di container 'kubectl'
                    script {
